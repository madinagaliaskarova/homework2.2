...
d) Реализовать интерфейс Printable классами 2й, 3й и 4й, переопределить метод
        ...
        f) В главном классе Main создать 3 различных объекта классов 2й, 3й и 4й с
        помощью метода createOcject, и распечатать по ним информацию методом print();
                */
...
public class Main {
    ...
    public static GrandMother createObject (String className){
        switch (className) {
            case "grandMother":
                GrandMother grandMother = new GrandMother("Madina",70);
                return grandMother;
            case "mother":
                Mother mother = new Mother("Zarina", 50, "Actress");
                return mother;
            case "daughter":
                Daughter daughter = new Daughter("Aisuluu", 50, "knitting");
                return daughter;
            case "grandDaughter":
                GrandDaughter grandDaughter = new GrandDaughter("Narine", 10, "Manty");
